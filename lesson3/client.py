...
from abis.abis import ERC20_ABI
...
client = Client("0xfc7d5bea5520a720a9aa2abc455790f01457556a6c35eb819417a9944c01f39f", "https://polygon.llamarpc.com")
print("Native balance: " + str(client.get_native_balance()))
print("GALAXIS: " + str(client.get_erc20_balance("0x3c69d114664d48357d820dbdd121a8071eac99bf")))
print("Send ERC20" + str(client.send_erc20_tokens("0x3c69d114664d48357d820dbdd121a8071eac99bf", "0xb69d7F30Ba4CDBcbd6656b4fe3E079e0954D59B3", 5)))
time.sleep(5)
print("Native balance: " + str(client.get_native_balance()))
print("GALAXIS: " + str(client.get_erc20_balance("0x3c69d114664d48357d820dbdd121a8071eac99bf")))
